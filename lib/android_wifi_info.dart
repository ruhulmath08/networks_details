...
class MyAndroidWifiInfo extends StatefulWidget {

  /*
  * Info
  * dependency: android_wifi_info 0.1.1
  * link: https://pub.dev/packages/android_wifi_info/example
  * */

  MyAndroidWifiInfo({Key key, this.title}) : super(key: key);

  static const String routeName = "/MyAndroidWifiInfo";

  final String title;

  @override
  _MyAndroidWifiInfoState createState() => new _MyAndroidWifiInfoState();
}

class _MyAndroidWifiInfoState extends State<MyAndroidWifiInfo> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text('Flutter Android'),
        actions: <Widget>[
          IconButton(
